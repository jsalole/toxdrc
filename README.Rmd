...
You can install the development version of **toxdrc** from [GitHub](https://github.com/jsalole/toxdrc) with `pak()`, or in base R with `install.packages()`.
...
## Acknowledgments
* This package is an extenision for the [drc](https://CRAN.R-project.org/package=drc) package.
